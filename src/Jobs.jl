...
[`AutoBZ.iterated_integration`](@ref) on it over the domain of the `BZ_lims` and a safely truncated
...
value and calls [`AutoBZ.iterated_integration`](@ref) on it over the domain of the `BZ_lims` and a
